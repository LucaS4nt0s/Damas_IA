...
public class Tabuleiro implements Cloneable {
    ...
    */
        ...
        switch (this.matriz[r1][c1]) {
            case '1': // brancas
                if(comeu && r1 < 4){
                    if(c1 < 4){
                        if(r2 == r1 + 2 && c2 == c1 + 2){
                            if(this.matriz[r1+1][c1+1] == '2' || this.matriz[r1+1][c1+1] == '4'){
                                if(this.matriz[r1+2][c1+2] == '0'){
                                    this.matriz[r1][c1] = '0';
                                    this.matriz[r1+1][c1+1] = '0';
                                    this.matriz[r2][c2] = '1';
                                    this.comeu = true;
                                    this.obrigadoComer = this.podeComer(r2, c2);
                                    return true;
                                }
                            }
                        }
                    ...
                    if (this.matriz[r2][c2] == '0') { // A casa de destino deve estar vazia
                        if(r2 == r1 - 1 && (c2 == c1 - 1 || c2 == c1 + 1)) { 
                            ...
                            if (this.matriz[tempR][tempC] == '2' || this.matriz[tempR][tempC] == '4') { // Verifica se a peça adversária está na casa intermediária
                                ...
                                pecasPretas--;
                                this.comeu = true;
                                this.obrigadoComer = podeComer(r2, c2);
                                return true;
                            } else {
                                return false;
                            }
                ...
                if(comeu && r1 > 1){
                    if(c1 < 4){
                        if(r2 == r1 - 2 && (c2 == c1 + 2 || c2 == c1 - 2)){
                            if(this.matriz[r1-1][c1+1] == '1' || this.matriz[r1-1][c1+1] == '3'){
                                if(this.matriz[r1-2][c1+2] == '0'){
                                    this.matriz[r1][c1] = '0';
                                    this.matriz[r1-1][c1+1] = '0';
                                    this.matriz[r2][c2] = '2';
            ...
            case '3':
                if((Math.abs(r2 - r1) == Math.abs(c2 - c1)) && this.matriz[r2][c2] == '0'){ // é diagonal 
                    ...
                    if(contPeca == 1){
                        ...
                        this.comeu = true;
                        this.obrigadoComer = podeComer(proxLinha, proxColuna);
                        pecasPretas--;
    ...
    public boolean fazerMovimento(int r1, int c1, int r2, int c2) {
        ...
        if (podeMover && this.obrigadoComer == false){
            if (this.turno == 1){
                this.turno = 2;
            } else {
                this.turno = 1;
